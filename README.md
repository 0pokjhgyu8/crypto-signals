...
| 自动 | 联邦基金利率 FFR | FRED |
| 自动 | 恐惧贪婪指数 | Alternative.me |
| 自动 | Funding Rate | OKX |
| 手填 | MVRV / NUPL / SOPR / Puell | Glassnode 付费墙 |
| 手填 | ETF 净流 | SoSoValue 无公开 API |
| 手填 | 稳定币供应 / Coinbase Premium | 需历史基线，暂关 |

链上估值层（最核心）在免费方案下仍需手填。若日后想全自动，见末尾「升级路线」。
...
- **路线 B**：链上指标用免费近似源（bitcoin-data 等）替代 Glassnode，覆盖升至 ~80%
- **路线 C**：接 Glassnode 付费 API（约 $800/月），13 条全自动
